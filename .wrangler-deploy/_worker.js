var Tt=Object.defineProperty;var We=e=>{throw TypeError(e)};var Ct=(e,t,r)=>t in e?Tt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var g=(e,t,r)=>Ct(e,typeof t!="symbol"?t+"":t,r),Fe=(e,t,r)=>t.has(e)||We("Cannot "+r);var o=(e,t,r)=>(Fe(e,t,"read from private field"),r?r.call(e):t.get(e)),x=(e,t,r)=>t.has(e)?We("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),f=(e,t,r,a)=>(Fe(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),P=(e,t,r)=>(Fe(e,t,"access private method"),r);var Ye=(e,t,r,a)=>({set _(s){f(e,t,s,r)},get _(){return o(e,t,a)}});var Qe=(e,t,r)=>(a,s)=>{let n=-1;return i(0);async function i(d){if(d<=n)throw new Error("next() called multiple times");n=d;let c,l=!1,u;if(e[d]?(u=e[d][0][0],a.req.routeIndex=d):u=d===e.length&&s||void 0,u)try{c=await u(a,()=>i(d+1))}catch(p){if(p instanceof Error&&t)a.error=p,c=await t(p,a),l=!0;else throw p}else a.finalized===!1&&r&&(c=await r(a));return c&&(a.finalized===!1||l)&&(a.res=c),a}},Mt=Symbol(),It=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,n=(e instanceof mt?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?$t(e,{all:r,dot:a}):{}};async function $t(e,t){const r=await e.formData();return r?Ht(r,t):{}}function Ht(e,t){const r=Object.create(null);return e.forEach((a,s)=>{t.all||s.endsWith("[]")?Vt(r,s,a):r[s]=a}),t.dot&&Object.entries(r).forEach(([a,s])=>{a.includes(".")&&(Ft(r,a,s),delete r[a])}),r}var Vt=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Ft=(e,t,r)=>{let a=e;const s=t.split(".");s.forEach((n,i)=>{i===s.length-1?a[n]=r:((!a[n]||typeof a[n]!="object"||Array.isArray(a[n])||a[n]instanceof File)&&(a[n]=Object.create(null)),a=a[n])})},lt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Lt=e=>{const{groups:t,path:r}=Bt(e),a=lt(r);return Ut(a,t)},Bt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const s=`@${a}`;return t.push([s,r]),s}),{groups:t,path:e}},Ut=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let s=e.length-1;s>=0;s--)if(e[s].includes(a)){e[s]=e[s].replace(a,t[r][1]);break}}return e},De={},Kt=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return De[a]||(r[2]?De[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:De[a]=[e,r[1],!0]),De[a]}return null},Ke=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Gt=e=>Ke(e,decodeURI),ct=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const s=t.charCodeAt(a);if(s===37){const n=t.indexOf("?",a),i=t.slice(r,n===-1?void 0:n);return Gt(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(s===63)break}return t.slice(r,a)},zt=e=>{const t=ct(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ce=(e,t,...r)=>(r.length&&(t=ce(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),dt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))a+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){r.length===0&&a===""?r.push("/"):r.push(a);const n=s.replace("?","");a+="/"+n,r.push(a)}else a+="/"+s}),r.filter((s,n,i)=>i.indexOf(s)===n)},Le=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ke(e,pt):e):e,ut=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const d=e.charCodeAt(i+t.length+1);if(d===61){const c=i+t.length+2,l=e.indexOf("&",c);return Le(e.slice(c,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";i=e.indexOf(`&${t}`,i+1)}if(a=/[%+]/.test(e),!a)return}const s={};a??(a=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const i=e.indexOf("&",n+1);let d=e.indexOf("=",n);d>i&&i!==-1&&(d=-1);let c=e.slice(n+1,d===-1?i===-1?void 0:i:d);if(a&&(c=Le(c)),n=i,c==="")continue;let l;d===-1?l="":(l=e.slice(d+1,i===-1?void 0:i),a&&(l=Le(l))),r?(s[c]&&Array.isArray(s[c])||(s[c]=[]),s[c].push(l)):s[c]??(s[c]=l)}return t?s[t]:s},Jt=ut,Wt=(e,t)=>ut(e,t,!0),pt=decodeURIComponent,Xe=e=>Ke(e,pt),pe,C,K,ft,gt,Ue,z,rt,mt=(rt=class{constructor(e,t="/",r=[[]]){x(this,K);g(this,"raw");x(this,pe);x(this,C);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});x(this,z,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const s=Object.keys(t)[0];return s?t[s].then(n=>(s==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,f(this,C,r),f(this,pe,{})}param(e){return e?P(this,K,ft).call(this,e):P(this,K,gt).call(this)}query(e){return Jt(this.url,e)}queries(e){return Wt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await It(this,e))}json(){return o(this,z).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,z).call(this,"text")}arrayBuffer(){return o(this,z).call(this,"arrayBuffer")}blob(){return o(this,z).call(this,"blob")}formData(){return o(this,z).call(this,"formData")}addValidatedData(e,t){o(this,pe)[e]=t}valid(e){return o(this,pe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Mt](){return o(this,C)}get matchedRoutes(){return o(this,C)[0].map(([[,e]])=>e)}get routePath(){return o(this,C)[0].map(([[,e]])=>e)[this.routeIndex].path}},pe=new WeakMap,C=new WeakMap,K=new WeakSet,ft=function(e){const t=o(this,C)[0][this.routeIndex][1][e],r=P(this,K,Ue).call(this,t);return r&&/\%/.test(r)?Xe(r):r},gt=function(){const e={},t=Object.keys(o(this,C)[0][this.routeIndex][1]);for(const r of t){const a=P(this,K,Ue).call(this,o(this,C)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Xe(a):a)}return e},Ue=function(e){return o(this,C)[1]?o(this,C)[1][e]:e},z=new WeakMap,rt),Yt={Stringify:1},ht=async(e,t,r,a,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(s?s[0]+=e:s=[e],Promise.all(n.map(d=>d({phase:t,buffer:s,context:a}))).then(d=>Promise.all(d.filter(Boolean).map(c=>ht(c,t,!1,a,s))).then(()=>s[0]))):Promise.resolve(e)},Qt="text/plain; charset=UTF-8",Be=(e,t)=>({"Content-Type":e,...t}),Ee,Pe,F,me,L,A,Re,fe,ge,re,_e,je,J,de,st,Xt=(st=class{constructor(e,t){x(this,J);x(this,Ee);x(this,Pe);g(this,"env",{});x(this,F);g(this,"finalized",!1);g(this,"error");x(this,me);x(this,L);x(this,A);x(this,Re);x(this,fe);x(this,ge);x(this,re);x(this,_e);x(this,je);g(this,"render",(...e)=>(o(this,fe)??f(this,fe,t=>this.html(t)),o(this,fe).call(this,...e)));g(this,"setLayout",e=>f(this,Re,e));g(this,"getLayout",()=>o(this,Re));g(this,"setRenderer",e=>{f(this,fe,e)});g(this,"header",(e,t,r)=>{this.finalized&&f(this,A,new Response(o(this,A).body,o(this,A)));const a=o(this,A)?o(this,A).headers:o(this,re)??f(this,re,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});g(this,"status",e=>{f(this,me,e)});g(this,"set",(e,t)=>{o(this,F)??f(this,F,new Map),o(this,F).set(e,t)});g(this,"get",e=>o(this,F)?o(this,F).get(e):void 0);g(this,"newResponse",(...e)=>P(this,J,de).call(this,...e));g(this,"body",(e,t,r)=>P(this,J,de).call(this,e,t,r));g(this,"text",(e,t,r)=>!o(this,re)&&!o(this,me)&&!t&&!r&&!this.finalized?new Response(e):P(this,J,de).call(this,e,t,Be(Qt,r)));g(this,"json",(e,t,r)=>P(this,J,de).call(this,JSON.stringify(e),t,Be("application/json",r)));g(this,"html",(e,t,r)=>{const a=s=>P(this,J,de).call(this,s,t,Be("text/html; charset=UTF-8",r));return typeof e=="object"?ht(e,Yt.Stringify,!1,{}).then(a):a(e)});g(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});g(this,"notFound",()=>(o(this,ge)??f(this,ge,()=>new Response),o(this,ge).call(this,this)));f(this,Ee,e),t&&(f(this,L,t.executionCtx),this.env=t.env,f(this,ge,t.notFoundHandler),f(this,je,t.path),f(this,_e,t.matchResult))}get req(){return o(this,Pe)??f(this,Pe,new mt(o(this,Ee),o(this,je),o(this,_e))),o(this,Pe)}get event(){if(o(this,L)&&"respondWith"in o(this,L))return o(this,L);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,L))return o(this,L);throw Error("This context has no ExecutionContext")}get res(){return o(this,A)||f(this,A,new Response(null,{headers:o(this,re)??f(this,re,new Headers)}))}set res(e){if(o(this,A)&&e){e=new Response(e.body,e);for(const[t,r]of o(this,A).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=o(this,A).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of a)e.headers.append("set-cookie",s)}else e.headers.set(t,r)}f(this,A,e),this.finalized=!0}get var(){return o(this,F)?Object.fromEntries(o(this,F)):{}}},Ee=new WeakMap,Pe=new WeakMap,F=new WeakMap,me=new WeakMap,L=new WeakMap,A=new WeakMap,Re=new WeakMap,fe=new WeakMap,ge=new WeakMap,re=new WeakMap,_e=new WeakMap,je=new WeakMap,J=new WeakSet,de=function(e,t,r){const a=o(this,A)?new Headers(o(this,A).headers):o(this,re)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,d]of n)i.toLowerCase()==="set-cookie"?a.append(i,d):a.set(i,d)}if(r)for(const[n,i]of Object.entries(r))if(typeof i=="string")a.set(n,i);else{a.delete(n);for(const d of i)a.append(n,d)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,me);return new Response(e,{status:s,headers:a})},st),j="ALL",Zt="all",er=["get","post","put","delete","options","patch"],bt="Can not add a route since the matcher is already built.",yt=class extends Error{},tr="__COMPOSED_HANDLER",rr=e=>e.text("404 Not Found",404),Ze=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},I,N,vt,$,ee,Ae,Te,he,sr=(he=class{constructor(t={}){x(this,N);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");x(this,I,"/");g(this,"routes",[]);x(this,$,rr);g(this,"errorHandler",Ze);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(f(this,$,t),this));g(this,"fetch",(t,...r)=>P(this,N,Te).call(this,t,r[1],r[0],t.method));g(this,"request",(t,r,a,s)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ce("/",t)}`,r),a,s)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(P(this,N,Te).call(this,t.request,t,void 0,t.request.method))})});[...er,Zt].forEach(n=>{this[n]=(i,...d)=>(typeof i=="string"?f(this,I,i):P(this,N,ee).call(this,n,o(this,I),i),d.forEach(c=>{P(this,N,ee).call(this,n,o(this,I),c)}),this)}),this.on=(n,i,...d)=>{for(const c of[i].flat()){f(this,I,c);for(const l of[n].flat())d.map(u=>{P(this,N,ee).call(this,l.toUpperCase(),o(this,I),u)})}return this},this.use=(n,...i)=>(typeof n=="string"?f(this,I,n):(f(this,I,"*"),i.unshift(n)),i.forEach(d=>{P(this,N,ee).call(this,j,o(this,I),d)}),this);const{strict:a,...s}=t;Object.assign(this,s),this.getPath=a??!0?t.getPath??ct:zt}route(t,r){const a=this.basePath(t);return r.routes.map(s=>{var i;let n;r.errorHandler===Ze?n=s.handler:(n=async(d,c)=>(await Qe([],r.errorHandler)(d,()=>s.handler(d,c))).res,n[tr]=s.handler),P(i=a,N,ee).call(i,s.method,s.path,n)}),this}basePath(t){const r=P(this,N,vt).call(this);return r._basePath=ce(this._basePath,t),r}mount(t,r,a){let s,n;a&&(typeof a=="function"?n=a:(n=a.optionHandler,a.replaceRequest===!1?s=c=>c:s=a.replaceRequest));const i=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};s||(s=(()=>{const c=ce(this._basePath,t),l=c==="/"?0:c.length;return u=>{const p=new URL(u.url);return p.pathname=p.pathname.slice(l)||"/",new Request(p,u)}})());const d=async(c,l)=>{const u=await r(s(c.req.raw),...i(c));if(u)return u;await l()};return P(this,N,ee).call(this,j,ce(t,"*"),d),this}},I=new WeakMap,N=new WeakSet,vt=function(){const t=new he({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,$,o(this,$)),t.routes=this.routes,t},$=new WeakMap,ee=function(t,r,a){t=t.toUpperCase(),r=ce(this._basePath,r);const s={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,s]),this.routes.push(s)},Ae=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Te=function(t,r,a,s){if(s==="HEAD")return(async()=>new Response(null,await P(this,N,Te).call(this,t,r,a,"GET")))();const n=this.getPath(t,{env:a}),i=this.router.match(s,n),d=new Xt(t,{path:n,matchResult:i,env:a,executionCtx:r,notFoundHandler:o(this,$)});if(i[0].length===1){let l;try{l=i[0][0][0][0](d,async()=>{d.res=await o(this,$).call(this,d)})}catch(u){return P(this,N,Ae).call(this,u,d)}return l instanceof Promise?l.then(u=>u||(d.finalized?d.res:o(this,$).call(this,d))).catch(u=>P(this,N,Ae).call(this,u,d)):l??o(this,$).call(this,d)}const c=Qe(i[0],this.errorHandler,o(this,$));return(async()=>{try{const l=await c(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return P(this,N,Ae).call(this,l,d)}})()},he),xt=[];function ar(e,t){const r=this.buildAllMatchers(),a=((s,n)=>{const i=r[s]||r[j],d=i[2][n];if(d)return d;const c=n.match(i[0]);if(!c)return[[],xt];const l=c.indexOf("",1);return[i[1][l],c]});return this.match=a,a(e,t)}var Me="[^/]+",we=".*",ke="(?:|/.*)",ue=Symbol(),nr=new Set(".\\+*[^]$()");function ir(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===we||e===ke?1:t===we||t===ke?-1:e===Me?1:t===Me?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var se,ae,H,oe,or=(oe=class{constructor(){x(this,se);x(this,ae);x(this,H,Object.create(null))}insert(t,r,a,s,n){if(t.length===0){if(o(this,se)!==void 0)throw ue;if(n)return;f(this,se,r);return}const[i,...d]=t,c=i==="*"?d.length===0?["","",we]:["","",Me]:i==="/*"?["","",ke]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let p=c[2]||Me;if(u&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ue;if(l=o(this,H)[p],!l){if(Object.keys(o(this,H)).some(m=>m!==we&&m!==ke))throw ue;if(n)return;l=o(this,H)[p]=new oe,u!==""&&f(l,ae,s.varIndex++)}!n&&u!==""&&a.push([u,o(l,ae)])}else if(l=o(this,H)[i],!l){if(Object.keys(o(this,H)).some(u=>u.length>1&&u!==we&&u!==ke))throw ue;if(n)return;l=o(this,H)[i]=new oe}l.insert(d,r,a,s,n)}buildRegExpStr(){const r=Object.keys(o(this,H)).sort(ir).map(a=>{const s=o(this,H)[a];return(typeof o(s,ae)=="number"?`(${a})@${o(s,ae)}`:nr.has(a)?`\\${a}`:a)+s.buildRegExpStr()});return typeof o(this,se)=="number"&&r.unshift(`#${o(this,se)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},se=new WeakMap,ae=new WeakMap,H=new WeakMap,oe),Ie,Ne,at,lr=(at=class{constructor(){x(this,Ie,{varIndex:0});x(this,Ne,new or)}insert(e,t,r){const a=[],s=[];for(let i=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${i}`;return s[i]=[l,c],i++,d=!0,l}),!d)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=s.length-1;i>=0;i--){const[d]=s[i];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(d)!==-1){n[c]=n[c].replace(d,s[i][1]);break}}return o(this,Ne).insert(n,t,a,o(this,Ie),r),a}buildRegExp(){let e=o(this,Ne).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,n,i)=>n!==void 0?(r[++t]=Number(n),"$()"):(i!==void 0&&(a[Number(i)]=++t),"")),[new RegExp(`^${e}`),r,a]}},Ie=new WeakMap,Ne=new WeakMap,at),cr=[/^$/,[],Object.create(null)],Ce=Object.create(null);function wt(e){return Ce[e]??(Ce[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function dr(){Ce=Object.create(null)}function ur(e){var l;const t=new lr,r=[];if(e.length===0)return cr;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,p],[m,k])=>u?1:m?-1:p.length-k.length),s=Object.create(null);for(let u=0,p=-1,m=a.length;u<m;u++){const[k,R,b]=a[u];k?s[R]=[b.map(([E])=>[E,Object.create(null)]),xt]:p++;let v;try{v=t.insert(R,p,k)}catch(E){throw E===ue?new yt(R):E}k||(r[p]=b.map(([E,w])=>{const y=Object.create(null);for(w-=1;w>=0;w--){const[T,D]=v[w];y[T]=D}return[E,y]}))}const[n,i,d]=t.buildRegExp();for(let u=0,p=r.length;u<p;u++)for(let m=0,k=r[u].length;m<k;m++){const R=(l=r[u][m])==null?void 0:l[1];if(!R)continue;const b=Object.keys(R);for(let v=0,E=b.length;v<E;v++)R[b[v]]=d[R[b[v]]]}const c=[];for(const u in i)c[u]=r[i[u]];return[n,c,s]}function le(e,t){if(e){for(const r of Object.keys(e).sort((a,s)=>s.length-a.length))if(wt(r).test(t))return[...e[r]]}}var W,Y,$e,kt,nt,pr=(nt=class{constructor(){x(this,$e);g(this,"name","RegExpRouter");x(this,W);x(this,Y);g(this,"match",ar);f(this,W,{[j]:Object.create(null)}),f(this,Y,{[j]:Object.create(null)})}add(e,t,r){var d;const a=o(this,W),s=o(this,Y);if(!a||!s)throw new Error(bt);a[e]||[a,s].forEach(c=>{c[e]=Object.create(null),Object.keys(c[j]).forEach(l=>{c[e][l]=[...c[j][l]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=wt(t);e===j?Object.keys(a).forEach(l=>{var u;(u=a[l])[t]||(u[t]=le(a[l],t)||le(a[j],t)||[])}):(d=a[e])[t]||(d[t]=le(a[e],t)||le(a[j],t)||[]),Object.keys(a).forEach(l=>{(e===j||e===l)&&Object.keys(a[l]).forEach(u=>{c.test(u)&&a[l][u].push([r,n])})}),Object.keys(s).forEach(l=>{(e===j||e===l)&&Object.keys(s[l]).forEach(u=>c.test(u)&&s[l][u].push([r,n]))});return}const i=dt(t)||[t];for(let c=0,l=i.length;c<l;c++){const u=i[c];Object.keys(s).forEach(p=>{var m;(e===j||e===p)&&((m=s[p])[u]||(m[u]=[...le(a[p],u)||le(a[j],u)||[]]),s[p][u].push([r,n-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,Y)).concat(Object.keys(o(this,W))).forEach(t=>{e[t]||(e[t]=P(this,$e,kt).call(this,t))}),f(this,W,f(this,Y,void 0)),dr(),e}},W=new WeakMap,Y=new WeakMap,$e=new WeakSet,kt=function(e){const t=[];let r=e===j;return[o(this,W),o(this,Y)].forEach(a=>{const s=a[e]?Object.keys(a[e]).map(n=>[n,a[e][n]]):[];s.length!==0?(r||(r=!0),t.push(...s)):e!==j&&t.push(...Object.keys(a[j]).map(n=>[n,a[j][n]]))}),r?ur(t):null},nt),Q,B,it,mr=(it=class{constructor(e){g(this,"name","SmartRouter");x(this,Q,[]);x(this,B,[]);f(this,Q,e.routers)}add(e,t,r){if(!o(this,B))throw new Error(bt);o(this,B).push([e,t,r])}match(e,t){if(!o(this,B))throw new Error("Fatal error");const r=o(this,Q),a=o(this,B),s=r.length;let n=0,i;for(;n<s;n++){const d=r[n];try{for(let c=0,l=a.length;c<l;c++)d.add(...a[c]);i=d.match(e,t)}catch(c){if(c instanceof yt)continue;throw c}this.match=d.match.bind(d),f(this,Q,[d]),f(this,B,void 0);break}if(n===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(o(this,B)||o(this,Q).length!==1)throw new Error("No active router has been determined yet.");return o(this,Q)[0]}},Q=new WeakMap,B=new WeakMap,it),xe=Object.create(null),X,S,ne,be,q,U,te,ye,fr=(ye=class{constructor(t,r,a){x(this,U);x(this,X);x(this,S);x(this,ne);x(this,be,0);x(this,q,xe);if(f(this,S,a||Object.create(null)),f(this,X,[]),t&&r){const s=Object.create(null);s[t]={handler:r,possibleKeys:[],score:0},f(this,X,[s])}f(this,ne,[])}insert(t,r,a){f(this,be,++Ye(this,be)._);let s=this;const n=Lt(r),i=[];for(let d=0,c=n.length;d<c;d++){const l=n[d],u=n[d+1],p=Kt(l,u),m=Array.isArray(p)?p[0]:l;if(m in o(s,S)){s=o(s,S)[m],p&&i.push(p[1]);continue}o(s,S)[m]=new ye,p&&(o(s,ne).push(p),i.push(p[1])),s=o(s,S)[m]}return o(s,X).push({[t]:{handler:a,possibleKeys:i.filter((d,c,l)=>l.indexOf(d)===c),score:o(this,be)}}),s}search(t,r){var c;const a=[];f(this,q,xe);let n=[this];const i=lt(r),d=[];for(let l=0,u=i.length;l<u;l++){const p=i[l],m=l===u-1,k=[];for(let R=0,b=n.length;R<b;R++){const v=n[R],E=o(v,S)[p];E&&(f(E,q,o(v,q)),m?(o(E,S)["*"]&&a.push(...P(this,U,te).call(this,o(E,S)["*"],t,o(v,q))),a.push(...P(this,U,te).call(this,E,t,o(v,q)))):k.push(E));for(let w=0,y=o(v,ne).length;w<y;w++){const T=o(v,ne)[w],D=o(v,q)===xe?{}:{...o(v,q)};if(T==="*"){const V=o(v,S)["*"];V&&(a.push(...P(this,U,te).call(this,V,t,o(v,q))),f(V,q,D),k.push(V));continue}const[G,qe,Z]=T;if(!p&&!(Z instanceof RegExp))continue;const M=o(v,S)[G],He=i.slice(l).join("/");if(Z instanceof RegExp){const V=Z.exec(He);if(V){if(D[qe]=V[0],a.push(...P(this,U,te).call(this,M,t,o(v,q),D)),Object.keys(o(M,S)).length){f(M,q,D);const ve=((c=V[0].match(/\//))==null?void 0:c.length)??0;(d[ve]||(d[ve]=[])).push(M)}continue}}(Z===!0||Z.test(p))&&(D[qe]=p,m?(a.push(...P(this,U,te).call(this,M,t,D,o(v,q))),o(M,S)["*"]&&a.push(...P(this,U,te).call(this,o(M,S)["*"],t,D,o(v,q)))):(f(M,q,D),k.push(M)))}}n=k.concat(d.shift()??[])}return a.length>1&&a.sort((l,u)=>l.score-u.score),[a.map(({handler:l,params:u})=>[l,u])]}},X=new WeakMap,S=new WeakMap,ne=new WeakMap,be=new WeakMap,q=new WeakMap,U=new WeakSet,te=function(t,r,a,s){const n=[];for(let i=0,d=o(t,X).length;i<d;i++){const c=o(t,X)[i],l=c[r]||c[j],u={};if(l!==void 0&&(l.params=Object.create(null),n.push(l),a!==xe||s&&s!==xe))for(let p=0,m=l.possibleKeys.length;p<m;p++){const k=l.possibleKeys[p],R=u[l.score];l.params[k]=s!=null&&s[k]&&!R?s[k]:a[k]??(s==null?void 0:s[k]),u[l.score]=!0}}return n},ye),ie,ot,gr=(ot=class{constructor(){g(this,"name","TrieRouter");x(this,ie);f(this,ie,new fr)}add(e,t,r){const a=dt(t);if(a){for(let s=0,n=a.length;s<n;s++)o(this,ie).insert(e,a[s],r);return}o(this,ie).insert(e,t,r)}match(e,t){return o(this,ie).search(e,t)}},ie=new WeakMap,ot),Et=class extends sr{constructor(e={}){super(e),this.router=e.router??new mr({routers:[new pr,new gr]})}},hr=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(n=>typeof n=="string"?n==="*"?()=>n:i=>n===i?i:null:typeof n=="function"?n:i=>n.includes(i)?i:null)(r.origin),s=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(i,d){var u;function c(p,m){i.res.headers.set(p,m)}const l=await a(i.req.header("origin")||"",i);if(l&&c("Access-Control-Allow-Origin",l),r.credentials&&c("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),i.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const p=await s(i.req.header("origin")||"",i);p.length&&c("Access-Control-Allow-Methods",p.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const k=i.req.header("Access-Control-Request-Headers");k&&(m=k.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await d(),r.origin!=="*"&&i.header("Vary","Origin",{append:!0})}},br=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,et=(e,t=vr)=>{const r=/\.([a-zA-Z0-9]+?)$/,a=e.match(r);if(!a)return;let s=t[a[1]];return s&&s.startsWith("text")&&(s+="; charset=utf-8"),s},yr={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},vr=yr,xr=(...e)=>{let t=e.filter(s=>s!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const r=t.split("/"),a=[];for(const s of r)s===".."&&a.length>0&&a.at(-1)!==".."?a.pop():s!=="."&&a.push(s);return a.join("/")||"."},Pt={br:".br",zstd:".zst",gzip:".gz"},wr=Object.keys(Pt),kr="index.html",Er=e=>{const t=e.root??"./",r=e.path,a=e.join??xr;return async(s,n)=>{var u,p,m,k;if(s.finalized)return n();let i;if(e.path)i=e.path;else try{if(i=decodeURIComponent(s.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(i))throw new Error}catch{return await((u=e.onNotFound)==null?void 0:u.call(e,s.req.path,s)),n()}let d=a(t,!r&&e.rewriteRequestPath?e.rewriteRequestPath(i):i);e.isDir&&await e.isDir(d)&&(d=a(d,kr));const c=e.getContent;let l=await c(d,s);if(l instanceof Response)return s.newResponse(l.body,l);if(l){const R=e.mimes&&et(d,e.mimes)||et(d);if(s.header("Content-Type",R||"application/octet-stream"),e.precompressed&&(!R||br.test(R))){const b=new Set((p=s.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(v=>v.trim()));for(const v of wr){if(!b.has(v))continue;const E=await c(d+Pt[v],s);if(E){l=E,s.header("Content-Encoding",v),s.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,d,s)),s.body(l)}await((k=e.onNotFound)==null?void 0:k.call(e,d,s)),await n()}},Pr=async(e,t)=>{let r;t&&t.manifest?typeof t.manifest=="string"?r=JSON.parse(t.manifest):r=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?r=JSON.parse(__STATIC_CONTENT_MANIFEST):r=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const s=r[e];if(!s)return null;const n=await a.get(s,{type:"stream"});return n||null},Rr=e=>async function(r,a){return Er({...e,getContent:async n=>Pr(n,{manifest:e.manifest,namespace:e.namespace?e.namespace:r.env?r.env.__STATIC_CONTENT:void 0})})(r,a)},_r=e=>Rr(e);const jr=[{id:"milwaukee-workstation",brand:"milwaukee",name:"PV5 밀워키 워크스테이션",fullName:"PV5 기아 밀워키 워크스테이션",description:"격벽타공판 + 격벽2단선반 + 워크스페이스 + 툴박스",price:485e4,image:"/static/images/milwaukee-workstation.jpg",sections:[{title:"기초자재",items:[{name:"태고합판 / 알루미늄체크판 / 논슬립",quantity:"1식"}]},{title:"격벽타공판",items:[{name:"M 격벽타공판",quantity:1},{name:"M 타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]},{title:"격벽2단선반",items:[{name:"M 2단 트레이",quantity:1},{name:"M 2단 트레이 로고",quantity:1},{name:"M 2단 프레임",quantity:2},{name:"M 트레이보강대",quantity:4}]},{title:"워크스페이스",items:[{name:"M 워크 타공판",quantity:1},{name:"M 워크 프레임 / 로고",quantity:"각 1"},{name:"M 워크 상판로고",quantity:1},{name:"M 3단 트레이/워크트레이",quantity:1},{name:"M 워크 세로보강대 (좌,우측)",quantity:2},{name:"M 워크 조명커버",quantity:1},{name:"M 트레이보강대",quantity:2},{name:"M 워크 트렁크브라켓",quantity:1},{name:"M 도어브라켓 - 우",quantity:1}]},{title:"툴박스",items:[{name:"팩아웃 거치대",quantity:4},{name:"팩아웃 라지 툴박스",quantity:1},{name:"오픈형 툴박스",quantity:1}]}]},{id:"milwaukee-smart",brand:"milwaukee",name:"PV5 밀워키 스마트 에디션",fullName:"PV5 기아 밀워키 스마트 에디션",description:"격벽타공판 + 격벽2단선반 + 3단선반 + 툴박스",price:449e4,image:"/static/images/milwaukee-smart.jpg",hasPositionOption:!0,sections:[{title:"기초자재",items:[{name:"태고합판 / 알루미늄체크판 / 논슬립",quantity:"1식"}]},{title:"격벽타공판",items:[{name:"M 격벽타공판",quantity:1},{name:"M 타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]},{title:"격벽2단선반",items:[{name:"M 2단 트레이",quantity:1},{name:"M 2단 트레이 로고",quantity:1},{name:"M 2단 프레임",quantity:2},{name:"M 트레이보강대",quantity:4}]},{title:"3단선반 (좌/우측)",items:[{name:"M 3단 트레이/워크트레이",quantity:2},{name:"M 3단 트레이 로고",quantity:1},{name:"M 3단 프레임 로고 (좌/우측)",quantity:"각 1"},{name:"M 3단 프레임",quantity:1},{name:"M 트레이보강대",quantity:6},{name:"M 트렁크 브라켓",quantity:1},{name:"M 도어브라켓 (좌)",quantity:1},{name:"M 도어브라켓 (우)",quantity:1}]},{title:"툴박스",items:[{name:"팩아웃 거치대",quantity:8},{name:"팩아웃 라지 툴박스",quantity:1},{name:"오픈형 툴박스",quantity:1}]}]},{id:"milwaukee-3shelf-parts",brand:"milwaukee",name:"PV5 밀워키 3단 부품선반",fullName:"PV5 기아 밀워키 3단 부품선반 (좌/우측)",description:"밀워키 단품 - 3단 부품선반",price:968e3,image:"/static/images/milwaukee-3shelf-parts.jpg",hasPositionOption:!0,sections:[{title:"3단 부품선반 (좌/우측)",items:[{name:"M 부품 트레이",quantity:2},{name:"M 부품 트레이 로고",quantity:1},{name:"M 부품 프레임 (일반)",quantity:1},{name:"M 부품 프레임 (좌측/우측)",quantity:"각 1"},{name:"M 부품 보강대",quantity:6},{name:"M 트렁크 브라켓",quantity:1},{name:"M 도어브라켓 (좌/우)",quantity:"각 1"}]}]},{id:"milwaukee-3shelf-standard",brand:"milwaukee",name:"PV5 밀워키 3단 선반",fullName:"PV5 기아 밀워키 3단 선반 (좌/우측)",description:"밀워키 단품 - 3단 선반",price:183e4,image:"/static/images/milwaukee-3shelf-standard.jpg",hasPositionOption:!0,sections:[{title:"3단 선반 (좌/우측)",items:[{name:"M 3단 트레이/워크트레이",quantity:2},{name:"M 3단 트레이 로고",quantity:1},{name:"M 3단 프레임 로고 (좌/우측)",quantity:"각 1"},{name:"M 3단 프레임",quantity:1},{name:"M 트레이 보강대",quantity:6},{name:"M 트렁크 브라켓",quantity:1},{name:"M 도어브라켓 (좌/우)",quantity:"각 1"}]}]},{id:"milwaukee-2shelf-partition",brand:"milwaukee",name:"PV5 밀워키 2단 선반",fullName:"PV5 카고 밀워키 2단 선반",description:"밀워키 단품 - 2단 선반",price:15e5,image:"/static/images/milwaukee-2shelf-partition.jpg",sections:[{title:"격벽 2단선반",items:[{name:"M 2단 트레이",quantity:1},{name:"M 2단 트레이 로고",quantity:1},{name:"M 2단 프레임",quantity:2},{name:"M 트레이보강대",quantity:4}]}]},{id:"milwaukee-partition-panel",brand:"milwaukee",name:"PV5 밀워키 격벽타공판",fullName:"PV5 카고 밀워키 격벽타공판",description:"밀워키 단품 - 격벽타공판",price:12e5,image:"/static/images/milwaukee-partition-panel.jpg",sections:[{title:"격벽타공판",items:[{name:"M 격벽타공판",quantity:1},{name:"M 타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]}]},{id:"milwaukee-floor-board",brand:"milwaukee",name:"적재함 평탄화 보드",fullName:"적재함 평탄화 보드 (태고합판 + 알루미늄체크판 + 논슬립)",description:"공통 단품 - 적재함 평탄화 보드",price:8e5,image:"/static/images/floor-board.jpg",sections:[{title:"적재함 평탄화 보드",items:[{name:"태고합판",quantity:1},{name:"알루미늄체크판",quantity:1},{name:"논슬립",quantity:1}]}]}],Nr=[{id:"kia-workstation",brand:"kia",name:"기아 PV5 워크스테이션",fullName:"기아 PV5 순정형 워크스테이션",description:"격벽타공판 + 3단부품선반 + 워크스페이스",price:339e4,image:"/static/images/kia-workstation.jpg",sections:[{title:"기초자재",items:[{name:"태고합판 / 알루미늄체크판 / 논슬립",quantity:"1식"}]},{title:"격벽타공판",items:[{name:"격벽타공판",quantity:1},{name:"타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]},{title:"3단부품선반",items:[{name:"부품 트레이",quantity:2},{name:"부품 트레이 로고",quantity:1},{name:"부품 프레임 (일반)",quantity:1},{name:"부품 프레임 (좌측)",quantity:1},{name:"부품 보강대",quantity:6},{name:"트렁크 브라켓",quantity:1},{name:"도어브라켓 (좌측/우측)",quantity:1}]},{title:"워크스페이스",items:[{name:"워크 타공판",quantity:1},{name:"워크 프레임 / 로고",quantity:"각 1"},{name:"워크 상판로고",quantity:1},{name:"3단 트레이/워크트레이",quantity:1},{name:"워크 세로보강대",quantity:2},{name:"워크 조명커버",quantity:1},{name:"트레이보강대",quantity:2},{name:"트렁크보강대",quantity:1},{name:"도어브라켓 - 우",quantity:1},{name:"트렁크 브라켓",quantity:1}]}]},{id:"kia-smart",brand:"kia",name:"기아 PV5 스마트 패키지",fullName:"기아 PV5 순정형 스마트 패키지",description:"격벽타공판 + 2단선반 + 3단선반",price:36e5,image:"/static/images/kia-smart.jpg",hasPositionOption:!0,sections:[{title:"기초자재",items:[{name:"태고합판 / 알루미늄체크판 / 논슬립",quantity:"1식"}]},{title:"격벽타공판",items:[{name:"격벽타공판",quantity:1},{name:"타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]},{title:"2단선반",items:[{name:"2단 트레이",quantity:1},{name:"2단 트레이 로고",quantity:1},{name:"2단 프레임",quantity:2},{name:"트레이보강대",quantity:4}]},{title:"3단선반 (좌/우측)",items:[{name:"3단 트레이/워크트레이",quantity:2},{name:"3단 트레이 로고",quantity:1},{name:"3단 프레임 로고 (좌/우측)",quantity:"각 1"},{name:"3단 프레임",quantity:1},{name:"트레이보강대",quantity:6},{name:"트렁크보강대",quantity:1},{name:"도어브라켓 (좌)",quantity:1},{name:"도어브라켓 (우)",quantity:1},{name:"트렁크브라켓 (좌,우)",quantity:1}]}]},{id:"kia-3shelf-parts",brand:"kia",name:"기아 PV5 3단 부품선반",fullName:"기아 PV5 순정형 3단 부품선반 (좌/우측)",description:"기아 단품 - 3단 부품선반",price:88e4,image:"/static/images/kia-3shelf-parts.jpg",hasPositionOption:!0,sections:[{title:"3단 부품선반 (좌/우측)",items:[{name:"부품 트레이",quantity:2},{name:"부품 트레이 로고",quantity:1},{name:"부품 프레임 (일반)",quantity:1},{name:"부품 프레임 (좌측/우측)",quantity:"각 1"},{name:"부품 보강대",quantity:6},{name:"트렁크 브라켓",quantity:1},{name:"도어브라켓 (좌)",quantity:1},{name:"도어브라켓 (우)",quantity:1}]}]},{id:"kia-3shelf-standard",brand:"kia",name:"기아 PV5 3단 선반",fullName:"기아 PV5 순정형 3단 선반 (좌/우측)",description:"기아 단품 - 3단 선반",price:121e4,image:"/static/images/kia-3shelf-standard.jpg",hasPositionOption:!0,sections:[{title:"3단 선반 (좌/우측)",items:[{name:"3단 트레이/워크트레이",quantity:2},{name:"3단 트레이 로고",quantity:1},{name:"3단 프레임 로고 (좌/우측)",quantity:"각 1"},{name:"3단 프레임",quantity:1},{name:"트레이 보강대",quantity:6},{name:"트렁크 보강대",quantity:1},{name:"도어브라켓 (좌)",quantity:1},{name:"도어브라켓 (우)",quantity:1},{name:"트렁크브라켓 (좌,우)",quantity:1}]}]},{id:"kia-2shelf-partition",brand:"kia",name:"PV5 카고 격벽 2단선반",fullName:"PV5 카고 격벽 2단선반",description:"기아 단품 - 격벽 2단선반",price:14e5,image:"/static/images/kia-2shelf-partition.jpg",sections:[{title:"격벽 2단선반",items:[{name:"2단 트레이",quantity:1},{name:"2단 트레이 로고",quantity:1},{name:"2단 프레임",quantity:2},{name:"트레이보강대",quantity:4}]}]},{id:"kia-partition-panel",brand:"kia",name:"기아 PV5 격벽타공판",fullName:"기아 PV5 순정형 격벽타공판",description:"기아 단품 - 격벽타공판",price:11e5,image:"/static/images/kia-partition-panel.jpg",sections:[{title:"격벽타공판",items:[{name:"격벽타공판",quantity:1},{name:"타공판보강대",quantity:3},{name:"브라켓 (상/중/하)",quantity:"각 2"}]}]},{id:"kia-floor-board",brand:"kia",name:"적재함 평탄화 보드",fullName:"적재함 평탄화 보드 (태고합판 + 알루미늄체크판 + 논슬립)",description:"공통 단품 - 적재함 평탄화 보드",price:8e5,image:"/static/images/floor-board.jpg",sections:[{title:"적재함 평탄화 보드",items:[{name:"태고합판",quantity:1},{name:"알루미늄체크판",quantity:1},{name:"논슬립",quantity:1}]}]}],Rt=[...jr,...Nr];function _t(e){return Rt.find(t=>t.id===e)}const O=new Et;O.use("/api/*",hr());O.use("/static/*",_r({root:"./public"}));O.get("/api/packages",e=>e.json({packages:Rt}));O.get("/api/packages/:id",e=>{const t=e.req.param("id"),r=_t(t);return r?e.json({package:r}):e.json({error:"Package not found"},404)});O.post("/api/ocr",async e=>{var t,r,a;try{const n=(await e.req.parseBody()).file;if(!n)return e.json({error:"No file uploaded"},400);console.log("OCR request received:",n.name,n.type,n.size);const i=await n.arrayBuffer(),d=Buffer.from(i).toString("base64"),c=(t=e.env)==null?void 0:t.GOOGLE_VISION_API_KEY;if(!c)return console.error("GOOGLE_VISION_API_KEY not found in environment"),e.json({success:!1,data:{customerName:"",phone:"",address:"",productName:"",productCode:"",orderNumber:"",orderDate:new Date().toLocaleDateString("ko-KR"),ocrRawText:"",aiSuccess:!1,recognitionSuccess:!1},message:"OCR 서비스 설정이 필요합니다. 관리자에게 문의하세요."},200);console.log("Calling Google Cloud Vision API...");const l=await fetch(`https://vision.googleapis.com/v1/images:annotate?key=${c}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:d},features:[{type:"DOCUMENT_TEXT_DETECTION",maxResults:1}]}]})});if(!l.ok){const w=await l.text();throw console.error("Google Vision API error:",l.status,w),new Error(`Google Vision API error: ${l.status}`)}const u=await l.json();console.log("Google Vision API response received");const p=(a=(r=u.responses)==null?void 0:r[0])==null?void 0:a.fullTextAnnotation,m=(p==null?void 0:p.text)||"",k=!!m;if(console.log("Extracted OCR text length:",m.length),console.log("OCR text preview:",m.substring(0,200)),!m||m.length<10)return console.warn("No text detected in image"),e.json({success:!1,data:{customerName:"",phone:"",address:"",productName:"",productCode:"",orderNumber:"",orderDate:new Date().toLocaleDateString("ko-KR"),ocrRawText:m,aiSuccess:!0,recognitionSuccess:!1},message:"이미지에서 텍스트를 인식할 수 없습니다. 이미지 품질을 확인해주세요."},200);const b=m?(w=>{var Je;const y={outputDate:"",deliveryNumber:"",receiverName:"",ordererName:"",receiverAddress:"",receiverPhone:"",deliveryMemo:"",orderNumber:"",productCode:"",productName:""};if(!w||w.length<5)return y;console.log("Parsing OCR text (우측 수령자 정보만):",w);const T=w.match(/(?:수령자|받는사람|수령인)([\s\S]*?)(?:공급자|SEQ\.|이하여백|$)/i),D=T?T[1]:w;console.log("Target text (수령자 영역):",D);const G=[/출력일자[\s\n:：]*(\d{4})년\s*(\d{1,2})월\s*(\d{1,2})일/i,/출력일[\s\n:：]*(\d{4})[.-](\d{1,2})[.-](\d{1,2})/i,/(\d{4})년\s*(\d{1,2})월\s*(\d{1,2})일/i];for(const _ of G){const h=w.match(_);if(h){y.outputDate=`${h[1]}년 ${h[2].padStart(2,"0")}월 ${h[3].padStart(2,"0")}일`,console.log("Output date found:",y.outputDate);break}}const qe=[/배송번호[\s\n]+(\d{8})/i];for(const _ of qe){const h=w.match(_);if(h&&h[1]){y.deliveryNumber=h[1].trim(),console.log("Delivery number found:",y.deliveryNumber);break}}const Z=[/수령자명[\s\n]+([가-힣]{2,10})(?:\s|\n|$)/i];for(const _ of Z){const h=w.match(_);if(h&&h[1]){y.receiverName=h[1].trim(),console.log("Receiver name found:",y.receiverName);break}}const M=[/주문자명[\s\n]+([가-힣]{2,10})(?:\s|\n|\(|수|$)/i];for(const _ of M){const h=w.match(_);if(h&&h[1]){y.ordererName=h[1].trim(),console.log("Orderer name found:",y.ordererName);break}}!y.ordererName&&y.receiverName&&(y.ordererName=y.receiverName);const He=[/수령자\s*주소[\s\n]+(\(\d{5}\)\s*[^\n]+)[\s\n]+([^\n]+?)(?=\n0|\n수령자|$)/i,/수령자\s*주소[\s\n]+(\(\d{5}\)\s*[^\n]+)/i,/수령자\s*주소[\s\n]+([^\n]+)[\s\n]+([^\n]+?)(?=\n0|\n수령자|$)/i,/수령자\s*주소[\s\n]+([^\n]+?)(?=\n0|\n수령자|$)/i,/주소[\s\n]+([^\n]+(?:\n[^\n]+)?)/i];for(const _ of He){const h=w.match(_);if(h){if(h[2]){const Dt=h[1].trim(),At=h[2].trim();y.receiverAddress=`${Dt} ${At}`}else h[1]&&(y.receiverAddress=h[1].trim());console.log("Receiver address found:",y.receiverAddress);break}}const V=[/(010)[-\s]*(\d{4})[-\s]*\n수령자\s*연락처1[\s\n]+수령자\s*연락처2[\s\n]+(\d{4})/i,/수령자\s*연락처1[\s\n]+(010[-\s]?\d{3,4}[-\s]?\d{4})/i];for(const _ of V){const h=w.match(_);if(h){h[3]?y.receiverPhone=`${h[1]}-${h[2]}-${h[3]}`:h[1]&&(y.receiverPhone=h[1].replace(/\s/g,"")),console.log("Receiver phone found:",y.receiverPhone);break}}const ve=[/배송메모[\s\n]+([가-힣\w\s]{3,50})(?=\n상품명|\n주문번호|$)/i];for(const _ of ve){const h=w.match(_);if(h&&h[1]&&!h[1].includes("상품명")&&!h[1].includes("주문")){y.deliveryMemo=h[1].trim(),console.log("Delivery memo found:",y.deliveryMemo);break}}const Ge=[/주문번호[\s\n]+(\d{18,20})/i,/(\d{18,20})/];for(const _ of Ge){const h=w.match(_);if(h&&h[1]){y.orderNumber=h[1].trim(),console.log("Order number found:",y.orderNumber);break}}const ze=w.match(/사업자등록번호[\s\n:：]+(\d{10})/i),Ve=ze?ze[1]:null,Nt=/1\/1[\s\n]+(\d{9})(?!\d)/i,qt=/상품번호[\s\n:：]+(\d{8,10})/i,Ot=/(?:^|\n)(\d{9})(?!\d)/gm,Oe=w.match(Nt),Se=w.match(qt);if(Oe&&Oe[1]&&Oe[1]!==Ve)y.productCode=Oe[1],console.log("Product code found (pattern 1):",y.productCode);else if(Se&&Se[1]&&Se[1]!==Ve)y.productCode=Se[1],console.log("Product code found (pattern 2):",y.productCode);else{let _;for(;(_=Ot.exec(w))!==null;)if(_[1]!==Ve&&!((Je=y.deliveryNumber)!=null&&Je.includes(_[1]))){y.productCode=_[1],console.log("Product code found (pattern 3):",y.productCode);break}}const St=[/(?:상품명|제품명|품명)[\s:：]*([^\n]{5,100})/i,/PV5[\s가-힣\w]+(?:워크스테이션|스마트|선반|격벽|밀워키|카고)/i];for(const _ of St){const h=w.match(_);if(h){y.productName=(h[1]||h[0]).trim(),console.log("Product name found:",y.productName);break}}return console.log("Final parsed data:",y),y})(m):{},v=b.receiverName&&b.receiverName.length>=2||b.receiverPhone&&b.receiverPhone.length>=10||b.receiverAddress&&b.receiverAddress.length>=10||b.orderNumber&&b.orderNumber.length>=8;console.log("Validation result:",{hasValidData:v,receiverName:b.receiverName,receiverPhone:b.receiverPhone,receiverAddress:b.receiverAddress,orderNumber:b.orderNumber});const E={outputDate:b.outputDate||"",deliveryNumber:b.deliveryNumber||"",receiverName:b.receiverName||"",ordererName:b.ordererName||"",receiverAddress:b.receiverAddress||"",receiverPhone:b.receiverPhone||"",deliveryMemo:b.deliveryMemo||"",orderNumber:b.orderNumber||"",productCode:b.productCode||"",productName:b.productName||"",ocrRawText:m,aiSuccess:k,recognitionSuccess:v};return console.log("Final OCR result:",E),!v&&k?(console.warn("OCR recognition failed - no valid data extracted"),e.json({success:!1,data:E,message:"OCR 인식에 실패했습니다. 이미지 품질을 확인하거나 수동으로 입력해주세요."},200)):k?e.json({success:!0,data:E}):(console.warn("AI binding not available or failed"),e.json({success:!1,data:E,message:"OCR 서비스를 사용할 수 없습니다. Cloudflare Pages에 배포 후 사용 가능합니다."},200))}catch(s){return console.error("OCR Error:",s),e.json({error:"OCR processing failed",message:s instanceof Error?s.message:"Unknown error",suggestion:"수동으로 입력해주세요."},500)}});O.post("/api/generate-report",async e=>{try{const t=await e.req.json(),{customerInfo:r,packageId:a,installDate:s,installAddress:n,installTime:i,notes:d}=t,c=_t(a);if(!c)return e.json({error:"Invalid package ID"},400);const l={id:`INSTALL-${Date.now()}`,createdAt:new Date().toISOString(),customerInfo:r,package:c,installDate:s,installAddress:n,installTime:i,notes:d,status:"pending"};return e.json({success:!0,report:l})}catch(t){return console.error("Report Generation Error:",t),e.json({error:"Failed to generate report"},500)}});O.post("/api/send-email",async e=>{try{const{env:t}=e,r=await e.req.json(),{recipientEmail:a,customerInfo:s,packages:n,installDate:i,installTime:d,installAddress:c,notes:l,attachmentImage:u,attachmentFileName:p,attachmentContentType:m}=r;if(!t.RESEND_API_KEY)return console.warn("RESEND_API_KEY not configured"),e.json({success:!1,message:"이메일 서비스가 설정되지 않았습니다. 관리자에게 문의하세요."},200);const k=n.map(w=>`
    ...
    `,b={from:"PV5 시공관리 <onboarding@resend.dev>",to:[a],subject:`[PV5 시공(예약) 확인서] ${(s==null?void 0:s.receiverName)||"고객"}님 시공(예약) 확인서`,html:R};u&&p&&(console.log("Adding attachment to email:",p),b.attachments=[{filename:p,content:u,content_type:m||"image/png"}]);const v=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${t.RESEND_API_KEY}`,"Content-Type":"application/json"},body:JSON.stringify(b)}),E=await v.json();return v.ok?(console.log("Email sent successfully:",E),e.json({success:!0,message:"이메일이 성공적으로 발송되었습니다!",emailId:E.id})):(console.error("Resend API Error:",E),e.json({success:!1,message:"이메일 발송에 실패했습니다. 다시 시도해주세요.",error:E},200))}catch(t){return console.error("Email sending error:",t),e.json({success:!1,message:"이메일 발송 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error"},500)}});O.post("/api/upload-image",async e=>{try{const{env:t}=e,a=(await e.req.formData()).get("image");if(!a)return e.json({success:!1,message:"이미지 파일이 없습니다."},400);const s=`images/${Date.now()}-${Math.random().toString(36).substring(7)}-${a.name}`;return await t.R2.put(s,a.stream()),e.json({success:!0,imageKey:s,filename:a.name})}catch(t){return console.error("Image upload error:",t),e.json({success:!1,message:"이미지 업로드 실패",error:t instanceof Error?t.message:"Unknown error"},500)}});O.post("/api/reports/save",async e=>{try{const{env:t}=e;if(!t.DB)return console.error("❌ D1 binding not found!",Object.keys(t)),e.json({success:!1,message:"D1 데이터베이스가 연결되지 않았습니다.",error:"D1 binding missing"},500);const r=await e.req.json(),{reportId:a,customerInfo:s,packages:n,packagePositions:i,installDate:d,installTime:c,installAddress:l,notes:u,installerName:p,attachmentImage:m,attachmentFileName:k}=r,R=a||`REPORT-${Date.now()}`,b=R.replace(/[^a-zA-Z0-9-_]/g,"_");console.log("Original reportId:",R),console.log("Sanitized finalReportId:",b);let v=null;if(m&&t.R2)try{v=`images/${Date.now()}-${b.replace(/[^a-zA-Z0-9-]/g,"_")}-${(k||"attachment.jpg").replace(/[^a-zA-Z0-9.-]/g,"_")}`,console.log("Saving image to R2:",v);const T=atob(m),D=new Uint8Array(T.length);for(let G=0;G<T.length;G++)D[G]=T.charCodeAt(G);await t.R2.put(v,D),console.log("Image saved to R2 successfully")}catch(T){console.error("R2 save error (continuing without image):",T),v=null}console.log("Preparing to save to D1..."),console.log("env.DB type:",typeof t.DB),console.log("env.DB:",t.DB),console.log("finalReportId:",b);const E=`INSERT OR REPLACE INTO reports (
    ...
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'), datetime('now'))`;console.log("SQL Query:",E),console.log("Calling env.DB.prepare()...");const w=t.DB.prepare(E);console.log("Statement prepared successfully"),console.log("Binding values...");const y=[b,JSON.stringify(s||{}),JSON.stringify(n||[]),JSON.stringify(i||{}),d||null,c||null,l||null,u||null,p||null,v||null,k||null];return console.log("Bind values count:",y.length),console.log("Bind values:",JSON.stringify(y,null,2)),await w.bind(...y).run(),console.log("Report saved to D1:",b),e.json({success:!0,message:"시공 확인서가 저장되었습니다!",reportId:b})}catch(t){return console.error("Report save error:",t),console.error("Error stack:",t instanceof Error?t.stack:"No stack"),console.error("Error details:",JSON.stringify(t,null,2)),e.json({success:!1,message:"저장 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error",errorStack:t instanceof Error?t.stack:void 0},500)}});O.get("/api/reports/list",async e=>{try{const{env:t}=e,r=t.DB.prepare(`
      SELECT 
      ...
      LIMIT 100
    `),{results:a}=await r.all(),s=a.map(n=>({reportId:n.report_id,id:n.report_id,customerInfo:n.customer_info?JSON.parse(n.customer_info):null,packages:n.packages?JSON.parse(n.packages):[],packagePositions:n.package_positions?JSON.parse(n.package_positions):{},installDate:n.install_date,installTime:n.install_time,installAddress:n.install_address,notes:n.notes,installerName:n.installer_name,imageKey:n.image_key,imageFilename:n.image_filename,createdAt:n.created_at,updatedAt:n.updated_at}));return e.json({success:!0,reports:s})}catch(t){return console.error("Report list error:",t),e.json({success:!1,reports:[],error:t instanceof Error?t.message:"Unknown error"},500)}});O.get("/api/reports/:id",async e=>{try{const{env:t}=e,r=e.req.param("id"),{results:a}=await t.DB.prepare(` // UPDATED
      SELECT  // UPDATED
    ...
    `).bind(r).all();if(a.length===0)return e.json({success:!1,message:"시공 확인서를 찾을 수 없습니다."},404);const s=a[0],n={reportId:s.report_id,id:s.report_id,customerInfo:s.customer_info?JSON.parse(s.customer_info):null,packages:s.packages?JSON.parse(s.packages):[],packagePositions:s.package_positions?JSON.parse(s.package_positions):{},installDate:s.install_date,installTime:s.install_time,installAddress:s.install_address,notes:s.notes,installerName:s.installer_name,imageKey:s.image_key,imageFilename:s.image_filename,createdAt:s.created_at,updatedAt:s.updated_at};return e.json({success:!0,report:n})}catch(t){return console.error("Report load error:",t),e.json({success:!1,message:"불러오기 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error"},500)}});O.patch("/api/reports/:id/complete",async e=>{try{const{env:t}=e,r=e.req.param("id");return t.DB?(await t.DB.prepare(`
      UPDATE reports 
      SET status = 'completed', updated_at = datetime('now')
      WHERE report_id = ?
    `).bind(r).run(),console.log("Report marked as completed:",r),e.json({success:!0,message:"시공이 완료되었습니다!"})):e.json({success:!1,message:"D1 데이터베이스가 연결되지 않았습니다."},500)}catch(t){return console.error("Complete report error:",t),e.json({success:!1,message:"시공 완료 처리 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error"},500)}});O.get("/api/reports/completed/list",async e=>{try{const{env:t}=e;if(!t.DB)return e.json({success:!1,message:"D1 데이터베이스가 연결되지 않았습니다."},500);const r=t.DB.prepare(`
      SELECT 
        id, report_id, customer_info, packages, package_positions,
        install_date, install_time, install_address, notes,
        installer_name, image_key, image_filename,
      ...
      LIMIT 1000
    `),{results:a}=await r.all(),s=a.map(n=>({reportId:n.report_id,id:n.report_id,customerInfo:n.customer_info?JSON.parse(n.customer_info):null,packages:n.packages?JSON.parse(n.packages):[],packagePositions:n.package_positions?JSON.parse(n.package_positions):{},installDate:n.install_date,installTime:n.install_time,installAddress:n.install_address,notes:n.notes,installerName:n.installer_name,imageKey:n.image_key,imageFilename:n.image_filename,createdAt:n.created_at,updatedAt:n.updated_at,status:n.status}));return e.json({success:!0,reports:s})}catch(t){return console.error("Completed reports list error:",t),e.json({success:!1,reports:[],error:t instanceof Error?t.message:"Unknown error"},500)}});O.delete("/api/reports/:id",async e=>{try{const{env:t}=e,r=e.req.param("id");if(!t.DB)return e.json({success:!1,message:"D1 데이터베이스가 연결되지 않았습니다."},500);if(await t.DB.prepare(`
      DELETE FROM reports WHERE report_id = ?
    `).bind(r).run(),t.R2){const{results:a}=await t.DB.prepare(`
        SELECT image_key FROM reports WHERE report_id = ?
      `).bind(r).all();if(a.length>0&&a[0].image_key)try{await t.R2.delete(a[0].image_key),console.log("Image deleted from R2:",a[0].image_key)}catch(s){console.error("R2 delete error (continuing):",s)}}return e.json({success:!0,message:"시공 확인서가 삭제되었습니다."})}catch(t){return console.error("Report delete error:",t),e.json({success:!1,message:"삭제 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error"},500)}});O.get("/api/reports/stats",async e=>{try{const{env:t}=e,{startDate:r,endDate:a}=e.req.query();if(!t.DB)return e.json({success:!1,message:"D1 데이터베이스가 연결되지 않았습니다."},500);let s=`
      SELECT 
        COUNT(*) as totalCount,
        install_date,
        packages
      FROM reports
      WHERE status = 'completed'
    `;const n=[];r&&a?(s+=" AND install_date BETWEEN ? AND ?",n.push(r,a)):r?(s+=" AND install_date >= ?",n.push(r)):a&&(s+=" AND install_date <= ?",n.push(a)),s+=" ORDER BY install_date DESC";const i=t.DB.prepare(s),{results:d}=n.length>0?await i.bind(...n).all():await i.all();return e.json({success:!0,stats:{totalCount:d.length,reports:d}})}catch(t){return console.error("Stats error:",t),e.json({success:!1,message:"통계 조회 중 오류가 발생했습니다.",error:t instanceof Error?t.message:"Unknown error"},500)}});O.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
        <meta charset="UTF-8">
  ...
  `));const tt=new Et,qr=Object.assign({"/src/index.tsx":O});let jt=!1;for(const[,e]of Object.entries(qr))e&&(tt.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),tt.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),jt=!0);if(!jt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{tt as default};
